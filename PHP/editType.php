<?php
    ...
    $typeToChange = $connection->real_escape_string($json_data['typeToChange']);
    $proj = $connection->real_escape_string($json_data['proj']);
    $newType = $connection->real_escape_string($json_data['newType']);
    ...
    $result = $connection->multi_query("CALL changeMarker_Type('$tk','$typeToChange','$proj','$newType')");
