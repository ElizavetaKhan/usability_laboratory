<?php
    ...
    $marker = $connection->real_escape_string($json_data['id_marker']);
    $newTime = $connection->real_escape_string($json_data['newTime']);
    ...
    $result = $connection->multi_query("CALL changeMarkerTime('$tk','$marker','$newTime')");
    if (!$result) {
