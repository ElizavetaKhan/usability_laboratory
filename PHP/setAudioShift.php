<?php
    ...
    $audio = $connection->real_escape_string($json_data['audio']);
    $shift = $connection->real_escape_string($json_data['shift']);
    ...
    $result = $connection->multi_query("CALL setAudioShift('$tk','$audio','$shift')");
    if (!$result) {
