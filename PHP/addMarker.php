<?php
    ...
    $time = $connection->real_escape_string($json_data['time']);
    $type = $connection->real_escape_string($json_data['type']);
    ...
    $result = $connection->multi_query("CALL addMarker('$comment','$type','$time','$tk','$session')");
